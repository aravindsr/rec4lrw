...
public class task1eval_rec4lrw_diversity {
	...
	public static void main (String[] args) throws IOException
	{
		...
		File file1 = new File("rec4lrwhits_newm_topics-diversityvalyes.txt");
		file1.createNewFile();
		...
		for (int k = 0; k < listOfFiles.length; k++) 
		{
		  ...
		  {
			  FileInputStream fstream2 = new FileInputStream("rec4lrwhits_newm/"+file.getName());
				BufferedReader br2 = new BufferedReader(new InputStreamReader(fstream2));
				String strLine2;
				Integer[] articleids= new Integer[20];
				int p=0;
				...
				while ((strLine2 = br2.readLine()) != null)
				{
					...
					articleids[p]=Integer.valueOf(data[1]);
					p++;
				}
